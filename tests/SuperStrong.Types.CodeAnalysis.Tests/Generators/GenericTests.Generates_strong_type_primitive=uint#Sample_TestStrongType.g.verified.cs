...
namespace Sample
{
    ...
    [global::System.ComponentModel.TypeConverterAttribute(typeof(global::SuperStrong.Types.Converters.StrongTypeConverter<TestStrongType, uint>))]
    [global::System.Text.Json.Serialization.JsonConverterAttribute(typeof(global::SuperStrong.Types.Converters.JsonStrongTypeConverter<TestStrongType, uint>))]
    partial class TestStrongType : global::SuperStrong.Types.IStrongType<TestStrongType, uint>
    {
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        private readonly uint _value;

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        private TestStrongType(uint value)
        {
            _value = value;
        }

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        public static TestStrongType From(uint value)
        {
            global::SuperStrong.Types.StrongType.EnsureValid<TestStrongType, uint>(value);

            return new TestStrongType(value);
        }

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        static TestStrongType global::SuperStrong.Types.IStrongType<TestStrongType, uint>.From(uint value)
        {
            return From(value);
        }

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        public static bool TryFrom([global::System.Diagnostics.CodeAnalysis.AllowNullAttribute] uint value,[global::System.Diagnostics.CodeAnalysis.MaybeNullWhenAttribute(false)] out TestStrongType result)
        {
            if (global::SuperStrong.Types.StrongType.IsValid<TestStrongType, uint>(value))
            {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        static bool global::SuperStrong.Types.IStrongType<TestStrongType, uint>.TryFrom([global::System.Diagnostics.CodeAnalysis.AllowNullAttribute] uint value,[global::System.Diagnostics.CodeAnalysis.MaybeNullWhenAttribute(false)] out TestStrongType result)
        {
            return TryFrom(value, out result);
        }

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        public uint AsPrimitive() => _value;

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        uint global::SuperStrong.Types.IStrongType<TestStrongType, uint>.AsPrimitive()
        {
            return AsPrimitive();
        }
    }
    ...
    {
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        static global::SuperStrong.Types.StrongTypeDefinition<uint> global::SuperStrong.Types.IStrongType<TestStrongType, uint>.Define() => global::SuperStrong.Types.StrongType.Define<uint>();
    }
    ...
    partial class TestStrongType : global::System.IParsable<TestStrongType>
    {
        ...
        {
            return From(InvokeParse<uint>(s, provider));
        ...
        {
            if (InvokeTryParse<uint>(s, provider, out var primitive))
            {
    ...
    partial class TestStrongType : global::System.IUtf8SpanParsable<TestStrongType>
    {
        ...
        {
            return From(InvokeParse<uint>(utf8Text, provider));
        ...
        {
            if (InvokeTryParse<uint>(utf8Text, provider, out var primitive))
            {
                return TryFrom(primitive, out result);
            }
    ...
    partial class TestStrongType : global::System.IFormattable
    {
        ...
        {
            return InvokeToString<uint>(_value, format, formatProvider);
    ...
    partial class TestStrongType : global::System.ISpanFormattable
    {
        ...
        {
            return InvokeTryFormat<uint>(_value, destination, out charsWritten, format, provider);
    ...
    partial class TestStrongType : global::System.IUtf8SpanFormattable
    {
        ...
        {
            return InvokeTryFormat<uint>(_value, utf8Destination, out bytesWritten, format, provider);
    ...
    partial class TestStrongType : global::System.IComparable<TestStrongType>
    {
        ...
        public int CompareTo(TestStrongType? other)
        {
            ...
            return InvokeCompareTo<uint>(_value, other._value);
    ...
    partial class TestStrongType : global::System.Numerics.IComparisonOperators<TestStrongType, TestStrongType, bool>
    {
        ...
        public static bool operator <(TestStrongType left, TestStrongType right)
        {
            ...
            return InvokeLessThan<uint>(left._value, right._value);
        ...
        public static bool operator <=(TestStrongType left, TestStrongType right)
        {
            ...
            return InvokeLessThanOrEqual<uint>(left._value, right._value);
        ...
        public static bool operator >(TestStrongType left, TestStrongType right)
        {
            ...
            return InvokeGreaterThan<uint>(left._value, right._value);
        ...
        public static bool operator >=(TestStrongType left, TestStrongType right)
        {
            ...
            return InvokeGreaterThanOrEqual<uint>(left._value, right._value);
