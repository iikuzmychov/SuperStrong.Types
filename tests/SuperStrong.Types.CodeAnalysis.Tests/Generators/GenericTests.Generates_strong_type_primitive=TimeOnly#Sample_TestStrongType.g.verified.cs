...
namespace Sample
{
    ...
    [global::System.ComponentModel.TypeConverterAttribute(typeof(global::SuperStrong.Types.Converters.StrongTypeConverter<TestStrongType, global::System.TimeOnly>))]
    [global::System.Text.Json.Serialization.JsonConverterAttribute(typeof(global::SuperStrong.Types.Converters.JsonStrongTypeConverter<TestStrongType, global::System.TimeOnly>))]
    partial class TestStrongType : global::SuperStrong.Types.IStrongType<TestStrongType, global::System.TimeOnly>
    {
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        private readonly global::System.TimeOnly _value;

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        private TestStrongType(global::System.TimeOnly value)
        {
            _value = value;
        }

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        public static TestStrongType From(global::System.TimeOnly value)
        {
            global::SuperStrong.Types.StrongType.EnsureValid<TestStrongType, global::System.TimeOnly>(value);

            return new TestStrongType(value);
        }

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        static TestStrongType global::SuperStrong.Types.IStrongType<TestStrongType, global::System.TimeOnly>.From(global::System.TimeOnly value)
        {
            return From(value);
        }

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        public static bool TryFrom([global::System.Diagnostics.CodeAnalysis.AllowNullAttribute] global::System.TimeOnly value,[global::System.Diagnostics.CodeAnalysis.MaybeNullWhenAttribute(false)] out TestStrongType result)
        {
            if (global::SuperStrong.Types.StrongType.IsValid<TestStrongType, global::System.TimeOnly>(value))
            {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        static bool global::SuperStrong.Types.IStrongType<TestStrongType, global::System.TimeOnly>.TryFrom([global::System.Diagnostics.CodeAnalysis.AllowNullAttribute] global::System.TimeOnly value,[global::System.Diagnostics.CodeAnalysis.MaybeNullWhenAttribute(false)] out TestStrongType result)
        {
            return TryFrom(value, out result);
        }

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        public global::System.TimeOnly AsPrimitive() => _value;

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        global::System.TimeOnly global::SuperStrong.Types.IStrongType<TestStrongType, global::System.TimeOnly>.AsPrimitive()
        {
            return AsPrimitive();
        }
    }
    ...
    {
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("SuperStrong.Types.CodeAnalysis.Generators", "1.0.0.0")]
        static global::SuperStrong.Types.StrongTypeDefinition<global::System.TimeOnly> global::SuperStrong.Types.IStrongType<TestStrongType, global::System.TimeOnly>.Define() => global::SuperStrong.Types.StrongType.Define<global::System.TimeOnly>();
    }
    ...
    partial class TestStrongType : global::System.IParsable<TestStrongType>
    {
        ...
        {
            return From(InvokeParse<global::System.TimeOnly>(s, provider));
        ...
        {
            if (InvokeTryParse<global::System.TimeOnly>(s, provider, out var primitive))
            {
    ...
    partial class TestStrongType : global::System.IFormattable
    {
        ...
        {
            return InvokeToString<global::System.TimeOnly>(_value, format, formatProvider);
    ...
    partial class TestStrongType : global::System.ISpanFormattable
    {
        ...
        {
            return InvokeTryFormat<global::System.TimeOnly>(_value, destination, out charsWritten, format, provider);
    ...
    partial class TestStrongType : global::System.IUtf8SpanFormattable
    {
        ...
        {
            return InvokeTryFormat<global::System.TimeOnly>(_value, utf8Destination, out bytesWritten, format, provider);
    ...
    partial class TestStrongType : global::System.IComparable<TestStrongType>
    {
        ...
        public int CompareTo(TestStrongType? other)
        {
            ...
            return InvokeCompareTo<global::System.TimeOnly>(_value, other._value);
