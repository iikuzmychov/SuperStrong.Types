...
public sealed partial class NpgsqlMaxValueValidatorAdapterCustomConversionTests(PostgresDatabaseFixture database)
    : NpgsqlValidationAdapterTest<NpgsqlMaxValueValidatorAdapterCustomConversionTests.TestDbContext>(database)
{
    [StrongType<int>]
