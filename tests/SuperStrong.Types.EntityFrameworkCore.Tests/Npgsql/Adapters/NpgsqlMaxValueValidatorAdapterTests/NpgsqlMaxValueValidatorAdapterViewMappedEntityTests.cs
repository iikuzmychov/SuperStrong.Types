...
public sealed partial class NpgsqlMaxValueValidatorAdapterViewMappedEntityTests(PostgresDatabaseFixture database)
    : NpgsqlValidationAdapterTest<NpgsqlMaxValueValidatorAdapterViewMappedEntityTests.TestDbContext>(database)
{
    [StrongType<int>]
