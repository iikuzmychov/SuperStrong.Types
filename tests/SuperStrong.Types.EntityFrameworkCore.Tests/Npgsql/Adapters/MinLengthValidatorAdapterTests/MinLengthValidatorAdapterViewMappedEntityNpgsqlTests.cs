...
public sealed partial class MinLengthValidatorAdapterViewMappedEntityNpgsqlTests(PostgresDatabaseFixture database)
    : NpgsqlValidationAdapterTest<MinLengthValidatorAdapterViewMappedEntityNpgsqlTests.TestDbContext>(database)
{
    [StrongType<string>]
