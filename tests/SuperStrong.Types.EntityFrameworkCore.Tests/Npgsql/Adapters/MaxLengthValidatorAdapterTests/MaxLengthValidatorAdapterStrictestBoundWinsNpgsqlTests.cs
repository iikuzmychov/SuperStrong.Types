...
public sealed partial class MaxLengthValidatorAdapterStrictestBoundWinsNpgsqlTests(PostgresDatabaseFixture database)
    : NpgsqlValidationAdapterTest<MaxLengthValidatorAdapterStrictestBoundWinsNpgsqlTests.TestDbContext>(database)
{
    [StrongType<string>]
