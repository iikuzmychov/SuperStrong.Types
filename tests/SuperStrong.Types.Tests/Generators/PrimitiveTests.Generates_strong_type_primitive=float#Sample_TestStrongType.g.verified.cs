...
namespace Sample
{
    partial class TestStrongType : global::SuperStrong.Types.IStrongType<TestStrongType, float>
    {
        ...
        public static TestStrongType Create(float value)
        {
    ...
    partial class TestStrongType : global::SuperStrong.Types.IHasStrongTypeDefinition<float>
    {
        public static global::SuperStrong.Types.StrongTypeDefinition<float> Definition { get; } = global::SuperStrong.Types.StrongType.Define<float>();

        static global::SuperStrong.Types.StrongTypeDefinition<float> global::SuperStrong.Types.IHasStrongTypeDefinition<float>.Definition => Definition;
    }
    ...
    partial class TestStrongType : global::System.IParsable<TestStrongType>
    {
        ...
        {
            return Create(InvokeParse<float>(s, provider));
        ...
        {
            if (InvokeTryParse<float>(s, provider, out var primitive) && global::SuperStrong.Types.StrongType.IsValid(primitive, Definition))
            {
    ...
    partial class TestStrongType : global::System.IUtf8SpanParsable<TestStrongType>
    {
        ...
        {
            return Create(InvokeParse<float>(utf8Text, provider));
        ...
        {
            if (InvokeTryParse<float>(utf8Text, provider, out var primitive) && global::SuperStrong.Types.StrongType.IsValid(primitive, Definition))
            {
                result = new TestStrongType(primitive);
                return true;
            }
