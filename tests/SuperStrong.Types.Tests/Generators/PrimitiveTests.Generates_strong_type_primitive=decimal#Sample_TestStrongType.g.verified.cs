...
namespace Sample
{
    ...
    partial class TestStrongType : global::System.IParsable<TestStrongType>
    {
        ...
        {
            if (InvokeTryParse<decimal>(s, provider, out var primitive) && global::SuperStrong.Types.StrongType.IsValid(primitive, Definition))
            {
    ...
    partial class TestStrongType : global::System.IUtf8SpanParsable<TestStrongType>
    {
        ...
        {
            if (InvokeTryParse<decimal>(utf8Text, provider, out var primitive) && global::SuperStrong.Types.StrongType.IsValid(primitive, Definition))
            {
                result = new TestStrongType(primitive);
                return true;
            }
